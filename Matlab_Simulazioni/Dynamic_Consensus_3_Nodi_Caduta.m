...
figure;
plot(1:timesteps, x1_values, 'r', 1:timesteps, x2_values, 'b', 1:timesteps, x3_values, 'y', 1:timesteps, media, 'g', 1:timesteps, media2, 'k');
xlabel('Time step');
ylabel('Water Level');
legend('Node 1', 'Node 2', 'Node 3', 'Average','Average after Node 1 Fault');
