...
IPAddress remoteIP1(192, 168, 158, 224);    // Cambia con l'indirizzo IP del primo Arduino 
unsigned int remotePort1 = 8888;        // Porta su cui ascolta il primo Arduino

// Indirizzo IP e porta della seconda pompa
IPAddress remoteIP2(192, 168, 158, 39);    // Cambia con l'indirizzo IP del secondo Arduino 
...
// Salva i valori nei vettori
  ...
  if (resval<=Lower_Medium3 && livello1 != 0){
    flag_1=1;
  ...
  else if(resval > Upper_Medium3 && flag_1==1){
    flag_1=0;
    Udp.beginPacket(remoteIP1, remotePort1);
    Udp.print(flag_1);
    Udp.endPacket();
  ...
  if (resval<=Lower_Medium3 && livello2 != 0){
    flag_2=1;
  ...
  else if(resval > Upper_Medium3 && flag_2==1){
    flag_2=0;
    Udp.beginPacket(remoteIP2, remotePort2);
    Udp.print(flag_2);
    Udp.endPacket();
