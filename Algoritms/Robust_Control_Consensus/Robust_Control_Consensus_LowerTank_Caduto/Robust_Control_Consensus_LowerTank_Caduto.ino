...
bool ricevuto = false, ricevuto1 = false, ricevuto2 = false;
...
void loop() {
  ...
  if(ricevuto2 == true){
    delta21 = delta21_pre - (x2 - x1);
    Serial.println("delta21 aggiornata");
  }
  else
  {
    Serial.println("Misura 1 non ricevuta");
    delta21 = 0;
  }

  //Algoritmo del consenso
  x2 = epsilon*delta21 + z;
...
if(counter2<70 || counter2>120){        //Per simulare caduta del nodo
