...
int resval ;      // variabile dato sensore
...
IPAddress remoteIP(192, 168, 158, 224);    // Cambia con l'indirizzo IP del secondo Arduino 
...
delay(1000);  // Attende 2 secondi prima di ricevere nuovi dati
